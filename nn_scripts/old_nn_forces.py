...
import argparse
sys.path.append("/home/mkunkel/propagation/NNsForMD") # pyNNsMD
...
with open(inputfile,"r") as data:
	...
	for i in range(data_size):
		...
		tmpy = []
		tmpy.append(float(energy.split()[0]) + float(energy.split()[1]))	#labels are split in electronic and repulsive energies, added here
		comp_tmp = []
